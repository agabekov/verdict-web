    ...
    <div class="footer">
      ...
      <div style="margin-top: 16px; font-size: 13px; color: white;">
        <div style="line-height: 1.6;">
          <div style="margin-bottom: 6px; cursor: pointer; padding: 4px; border-radius: 4px; transition: background 0.2s;" onclick="copyToClipboard('bc1qhxrw9h0f9uavnt0anakgav4qek4ph45yw4f68n', this)" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='transparent'">BTC: bc1qhxrw9h0f9uavnt0anakgav4qek4ph45yw4f68n</div>
          <div style="margin-bottom: 6px; cursor: pointer; padding: 4px; border-radius: 4px; transition: background 0.2s;" onclick="copyToClipboard('0xDf69430735C406Bb29B90c35B9C5193F018183CA', this)" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='transparent'">ETH: 0xDf69430735C406Bb29B90c35B9C5193F018183CA</div>
          <div style="margin-bottom: 6px; cursor: pointer; padding: 4px; border-radius: 4px; transition: background 0.2s;" onclick="copyToClipboard('HyE3ydPkpxr7SZdm5uk8EKv7ruxTwDH7vLYF2PW3jABW', this)" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='transparent'">SOL: HyE3ydPkpxr7SZdm5uk8EKv7ruxTwDH7vLYF2PW3jABW</div>
          <div style="cursor: pointer; padding: 4px; border-radius: 4px; transition: background 0.2s;" onclick="copyToClipboard('TPN3m8bQdfkwYjYg66t5gtqj9MvY2dpqdQ', this)" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='transparent'">TRX: TPN3m8bQdfkwYjYg66t5gtqj9MvY2dpqdQ</div>
        </div>
      </div>
    </div>
  </div>
